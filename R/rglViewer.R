...
rglViewer <- function(..., background = 'gray') {
  ...
  doMapply <- function(.ele, FUN, scale_factor){
    mapply(function(.color, .tag, .x, .y, .z){
      shade3d(scale3d(translate3d(FUN(col =.color,
                              tag =.tag),
                          x = .x,
                          y = .y,
                          z = .z),
  ...
  null <- mapply(geos, names(geos), FUN=function(.ele, .name){
    switch(.ele$type,
            ...
            box={
              doMapply(.ele, cube3d, list(x=.ele$properties$width,
            ...
            dodecahedron={
              # mapply(function(.color, .tag, .x, .y, .z, .r){
              #   shade3d(translate3d(dodecahedron3d(col =.color,
              #                           tag =.tag,
              #                           radius = .r),
              #                       x = .x,
              #                       y = .y,
              ...
              doMapply(.ele, dodecahedron3d, list(x=.ele$properties$radius,
                                                  y=.ele$properties$radius,
                                                  z=.ele$properties$radius))
            },
            icosahedron={
              doMapply(.ele, icosahedron3d, list(x=.ele$properties$radius,
                                                 y=.ele$properties$radius,
                                                 z=.ele$properties$radius))
            },
            octahedron={
              doMapply(.ele, octahedron3d, list(x=.ele$properties$radius,
                                                y=.ele$properties$radius,
                                                z=.ele$properties$radius))
            },
            sphere={
            ...
            tetrahedron={
              doMapply(.ele, tetrahedron3d, list(x=.ele$properties$radius,
                                                 y=.ele$properties$radius,
                                                 z=.ele$properties$radius))
            },
            label={
