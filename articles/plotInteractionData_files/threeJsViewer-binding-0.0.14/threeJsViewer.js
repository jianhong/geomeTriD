HTMLWidgets.widget({
  ...
  factory: function(el, width, height){
    ...
    const importPromise = import('../tjviewer-0.0.1/tjviewer.module.js');//import('https://cdn.jsdelivr.net/gh/jianhong/geometrid/inst/htmlwidgets/lib/tjviewer/tjviewer.module.js');
    async function run() {
